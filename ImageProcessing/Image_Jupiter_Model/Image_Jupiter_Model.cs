...
namespace Image_Jupiter_Model
{
    public class ImageJupiterModel : ImageInterface, IDisposable
    {
        ...
        public bool Initialize(string id)
        {
            ...
            try
            {
                Bitmap bmp = (Bitmap)Image.FromFile("Jupiter.bmp", false);
